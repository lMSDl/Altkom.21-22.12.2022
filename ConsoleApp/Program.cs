...
var contextOptions = new DbContextOptionsBuilder<Context>()
    .UseSqlServer(@"Server=.\SqlExpress;Database=EF6Core;Integrated security=true", x => x.UseNetTopologySuite())
...
static void View(DbContextOptions<Context> contextOptions)
{
    using (var context = new Context(contextOptions))
    {
